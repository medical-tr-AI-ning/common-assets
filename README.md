# medical tr.AI.ning - Common Medical Assets
...
**This repository contains common medical assets, which are ready for use in Unity projects, optimized for the HDRP pipeline. 
These assets are used in the [medical tr.AI.ning VR Runtime](https://github.com/medical-tr-AI-ning/vr-runtime) and the [supplemented Authoring Tool](https://github.com/medical-tr-AI-ning/authoring-tool), but also suitable for use in any other projects. GPL-3.0 license terms apply.**
